...
/**----导入外部的组件类---**/
const icon_homepage_message = require('../images/icon_homepage_message.png');
const icon_homepage_scan = require('../images/icon_homepage_scan.png');
...
export default class Home extends Component {
  ...
  // 首页的导航条
            ...
            <View style={styles.navBarStyle}>
                ...
                <View style={styles.rightNavViewStyle}>
                    <TouchableOpacity onPress={()=>{alert('点击了')}}>
                        <Image source={icon_homepage_message} style={styles.navRightImgStyle}/>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>{alert('点击了')}}>
                        <Image source={icon_homepage_scan} style={styles.navRightImgStyle} />
                    </TouchableOpacity>
                </View>
            </View>
        )
    ...
    dealWithUrl(url){
      ...
      console.log("aaaa22",url.replace('imeituan://www.meituan.com/web/?url=', ''));
