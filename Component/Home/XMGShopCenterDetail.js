...
const icon_camera_back_normal = require('../images/icon_camera_back_normal.png');
const icon_mine_setting = require('../images/icon_mine_setting.png');
        ...
        return(
            <View style={styles.navOutViewStyle}>
                <TouchableOpacity onPress={()=>{this.props.navigator.pop()}} style={styles.leftViewStyle}>
                    <Image source={icon_camera_back_normal} style={styles.navImageStyle}/>
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={()=>{alert('点了!')}} style={styles.rightViewStyle}>
                    <Image source={icon_mine_setting} style={styles.navImageStyle}/>
                </TouchableOpacity>
            </View>
        )
    }
