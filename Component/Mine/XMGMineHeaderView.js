...
const avatar_vip = require('../images/avatar_vip.png');
       ...
       return(
          <View style={styles.topViewStyle}>
             ...
             <View style={styles.centerViewStyle}>
                 ...
                 <Image source={avatar_vip} style={{width:17, height:17}}/>
             </View>
              {/*--右边的箭头--*/}
             <Image source={icon_cell_rightarrow} style={{width:8, height:13, marginRight:8}}/>
          </View>
       )
    }
